/**
 * Constants for the Swiss Ephemeris WebAssembly Library
 */

export const SE_AUNIT_TO_KM = 149597870.7;
export const SE_AUNIT_TO_LIGHTYEAR = 1.5812507409819728411242766893179e-5; // = 1.0 / 63241.07708427
export const SE_AUNIT_TO_PARSEC = 4.8481368110952742659276431719005e-6; // = 1.0 / 206264.8062471
